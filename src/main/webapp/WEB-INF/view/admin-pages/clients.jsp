...
<body>
	...
	<div id="page-content">
		<table id="clients-table">
			<thead>
				<tr>
					<th class="number-column"><p class="table-heading-text">#</p></th>
					<th class="name-column"><p class="table-heading-text">
							<fmt:message key="name" />
						</p></th>
					<th class="surname-column"><p class="table-heading-text">
							<fmt:message key="surname" />
						</p></th>
					<th class="login-column"><p class="table-heading-text">
							<fmt:message key="login" />
						</p></th>
					<th class="is-blocked-column"><p class="table-heading-text">
							<fmt:message key="is-user-blocked" />
						</p></th>
					<th class="set-user-state-column"><p class="table-heading-text">
						...
						<c:choose>
							<c:when test="${client.isBlocked}">
								...
								<td><a class="in-column-link"
									href="controller?command=setUserState&userId=${client.id}&state=0"><fmt:message
											key="unban" /></a></td>
							</c:when>
							<c:otherwise>
								<td><img src="static/images/pending.png" alt="pending image" class="pending-image"></td>
								<td><a class="in-column-link"
									href="controller?command=setUserState&userId=${client.id}&state=1"
